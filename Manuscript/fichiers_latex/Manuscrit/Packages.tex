...
\usepackage[french,english]{babel}  % francais = french babel
...
\DeclareFloatingEnvironment[fileext=mod,listname={List of Models},placement={!ht},name=Model]{modelfloat}

\newcounter{model}
\newenvironment{model}[1][htbp]{
	\refstepcounter{model}
	\begin{modelfloat}[#1]
		\begin{equation}
			\textsc{Model} \theencadre\\
		}{
		\end{equation}
	\end{modelfloat}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%                  Packages pour inserer du code                %%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\usepackage{listings}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%                  Package pour faire une citation                %%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hypersetup{
 colorlinks=true,
 linkcolor=BleuPetrole,
 urlcolor=BleuPetrole,
 citecolor=BleuPetrole,
 filecolor=VertVert
 }

% on décommente ici pour une version imprimable tout en noir:
%\hypersetup{
% colorlinks=true,
% linkcolor=black,
% urlcolor=black,
...
\usepackage{cleveref}
\crefname{modelfloat}{Model}{Models}